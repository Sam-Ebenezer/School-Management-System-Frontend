...
function UserDelete(){
    ...
    const getState=(obj)=>{
        ...
        const delete_url="https://orange-ring-cello.glitch.me/user/delete-user/"+obj["_id"]
    ...
    return(
        ...
        <h3 class="text-center mb-4 mt-2 text-decoration-underline">DELETE USER DATA</h3>
